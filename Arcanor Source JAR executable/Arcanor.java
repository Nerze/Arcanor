...
public class Arcanor{
    ...
    public JFrame addComponentToPane() {
		...
		try{
			...
			background = new JLabel(new ImageIcon(getClass().getResource("/images/background.gif")));
			frame.add(background);
			background.setLayout(new BorderLayout());
			ImageIcon icon = new ImageIcon(getClass().getResource("/images/rigologo.png"));
			frame.setIconImage(icon.getImage());
			try {
				InputStream is = this.getClass().getResourceAsStream("/songs/bgm.wav");
        ...
        //~ try {
            //~ in = new BufferedInputStream(new FileInputStream(new File(
                    //~ getClass().getClassLoader()
                            //~ .getResource("/songs/bgm.wav").getPath())));
		...
		//~ try {
			//~ InputStream is = getClass().getResourceAsStream("/songs/bgm.wav");
    ...
    private static void createAndShowGUI() {
		...
		JFrame frame = demo.addComponentToPane();
