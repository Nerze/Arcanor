...
public class Board implements Serializable{
	...
	/**
	 * This method return the grid of board
	 * @return the grid
	 */
	public Piece[][] getGrid(){return this.grid;}
	
	/**
	 * This method set the victory point of board
	 * @param victorypoint
	 */
	public void setVictoryPoint(int victoryPoints){this.victoryPoints = victoryPoints;}
