...
public class Game implements Serializable{
	...
	public void initializePanel(JPanel cards, SaveMenu saveMen){
		...
		empt.setFont(font);
		empt.setPreferredSize(new Dimension(250, 60));
		empt.setBackground(Color.DARK_GRAY);
		empt.setForeground(Color.ORANGE);
		empt.addMouseListener(new EmptyListener(this,empt)); 
		
		ButtonMenu sav = new ButtonMenu("Save", SAVEMENU);
		sav.setFont(font);
		sav.setBackground(Color.DARK_GRAY);
		sav.setForeground(Color.ORANGE);
		sav.setPreferredSize(new Dimension(100, 60));
		...
		moveMethod.setFont(font);
		moveMethod.setBackground(Color.DARK_GRAY);
		moveMethod.setForeground(Color.ORANGE);
		moveMethod.setPreferredSize(new Dimension(200, 60));
